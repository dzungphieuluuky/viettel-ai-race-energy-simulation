...
function simParams = addDerivedParams(simParams)    
    ...
    switch simParams.deploymentScenario
        ...
        case 'highway'  
            simParams.maxRadius = getFieldOrDefault(simParams, 'maxRadius', 1732);
            simParams.highwayLength = getFieldOrDefault(simParams, 'highwayLength', 10000);
            simParams.numLanes = getFieldOrDefault(simParams, 'numLanes', 3);
            simParams.laneWidth = getFieldOrDefault(simParams, 'laneWidth', 3.5);
    end
